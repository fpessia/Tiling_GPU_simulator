...
def Two_level_Round_Robin_scheduler(CTA_list, to_schedule_CTA_for_this_cluster,number_of_CTA_per_MS, number_of_MS_per_cluster, result_list, faulty_MS, block_executed_by_fauly_MS,Scheduler_result, cluster_index ):
