...
def Distributed_CTA_scheduler(CTA_list,to_schedule_CTAs_per_MS,number_of_MS_per_cluster,number_of_CTAs_per_MS, result_list, init_index,faulty_MS = -1, block_executed_by_fauly_MS = None):
