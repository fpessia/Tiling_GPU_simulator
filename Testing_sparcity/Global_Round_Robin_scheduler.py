...
def Global_Round_Robin_scheduler(CTA_list, to_schedule_CTA_for_this_cluster, number_of_MS_per_cluster,number_of_CTA_per_MS, result_list,faulty_MS = -1, block_executed_by_fauly_MS =  None,Scheduler_result = None, cluster_index = -1):
